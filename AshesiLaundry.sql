...
INSERT INTO EQUIPMENT (equip_name, quantity, brand, last_servicing_date, next_servicing_date)
values ('Washing Machine', 8, 'Samsung', '2021-1-26', '2021-7-26'),
		('Dryer', 4, 'LG', '2022-2-19', '2022-5-19'),
		('Iron', 10, 'Philips', '2021-11-30', '2022-1-30'),
		('Ironing Board', 5, 'Brabandia', '2022-4-11', '2022-5-11'),
		('Drying Rack', 10, 'HoneyCandDo', '2022-8-24', '2022-9-24'),
		('Dry CLeaning Machine', '1', 'Sharing', '2022-07-01', '2022-09-01');
